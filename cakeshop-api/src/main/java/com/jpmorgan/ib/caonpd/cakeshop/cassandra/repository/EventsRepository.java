...
//            getCassandraTemplate().insert(event);
//        }
    }

    public void save(List<Event> events) {
//        if (null != getCassandraTemplate()) {
//            getCassandraTemplate().insert(events);
//        }
    }

    public void reset() {
//        if (null != getCassandraTemplate()) {
//            getCassandraTemplate().deleteAll(Event.class);
//        }
    }
...
//            }
//            List<Event> events = getCassandraTemplate().query(creator, new PreparedStatementBinder() {
//
//                @Override
