 ...
 */
//@Repository
public class BlockRepository extends BaseRepository{
...
//            getCassandraTemplate().insert(block);
//        }
    }

    public void save(LatestBlockNumber blockNumber) {
//        if (null != getCassandraTemplate()) {
//            getCassandraTemplate().update(blockNumber);
//        }
    }
...
//            }
//            Block block = getCassandraTemplate().query(creatorBlock, new PreparedStatementBinder() {
//                @Override
...
//            }
//
//            latest = getCassandraTemplate().query(creatorLatest, new ResultSetExtractor<BigInteger>() {
//                @Override
...
//        }
    ...
    public void reset() {
//        if (null != getCassandraTemplate()) {
//            getCassandraTemplate().deleteAll(Block.class);
//        }
    }
