...
//            getCassandraTemplate().insert(txn);
//        }
    }

    public void save(List<Transaction> txns) {
//        if (null != getCassandraTemplate()) {
//            getCassandraTemplate().insert(txns);
//        }
    }

    public void reset() {
//        if (null != getCassandraTemplate()) {
//            getCassandraTemplate().deleteAll(Transaction.class);
//        }
    }
...
//        List<Transaction> txns = getCassandraTemplate().query(creator, new PreparedStatementBinder() {
//
//            @Override
